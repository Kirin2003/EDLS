 ...
 */
public class CIP2 extends IdentifyTool {
    /**
     * 哈希函数的个数, 用于意外标签去除阶段
     */
     ...
     */
    public CIP2(Logger logger, Recorder recorder, Environment environment) {
    ...
    public void execute() {
        ...
        int sum = 0; for(Integer slot: recorder1.roundSlotCountList) {sum += slot;}
